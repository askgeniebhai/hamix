...
const StorageService = (() => {
    ...
    return {
        ...
        loadWebsites: () => useBackend() ? loadRemote('websites') : Promise.resolve([]),
        loadDeployments: () => useBackend() ? loadRemote('deployments') : Promise.resolve([]),
        loadCustomerSuccess: () => useBackend() ? loadRemote('customer-success') : Promise.resolve([]),
        createCustomerSuccess: (payload) => useBackend() ? ApiService.post('/api/customer-success', payload) : Promise.resolve(null),
        updateCustomerSuccess: (id, payload) => useBackend() ? ApiService.post(`/api/customer-success/${encodeURIComponent(id)}`, payload) : Promise.resolve(payload),
        loadCustomerSuccessActivities: (id) => useBackend() ? ApiService.get(`/api/customer-success/${encodeURIComponent(id)}/activities`) : Promise.resolve({ data: [] }),
        addCustomerSuccessActivity: (id, payload) => useBackend() ? ApiService.post(`/api/customer-success/${encodeURIComponent(id)}/activities`, payload) : Promise.resolve(payload),
        createDeployment: (payload) => useBackend() ? ApiService.post('/api/deployments', payload) : Promise.resolve(null),
        updateDeploymentStatus: (id, status) => useBackend() ? ApiService.post(`/api/deployments/${encodeURIComponent(id)}/status`, { status }) : Promise.resolve(null),
        createWebsiteProject: (payload) => useBackend() ? ApiService.post('/api/websites', payload) : Promise.resolve(null),
        regenerateWebsiteProject: (projectId, payload = {}) => useBackend() ? ApiService.post('/api/websites', { ...payload, projectId, regenerate: true }) : Promise.resolve(null),
        updateWebsiteProjectStatus: (id, status) => useBackend() ? ApiService.post(`/api/websites/${encodeURIComponent(id)}/status`, { status }) : Promise.resolve(null),
        loadWebsiteVersions: (id) => useBackend() ? ApiService.get(`/api/websites/${encodeURIComponent(id)}/versions`) : Promise.resolve({ data: [] }),
